...
<div class="container">
    ...
    <div class="row justify-content-center">
        <upload-videos inline-template :channel="{{$channel}}">
            <div class="col-md-8">
                <div class="card d-flex justify-content-center p-3" v-if="!selected">
                    <input type="file" id="video-files" style="display:none" multiple name="video" ref="videos" @change="upload">
                ...
                <div class="card p-3" v-else>
                    <div class="my-4" v-for="video in videos">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div v-if="!video.thumb" class="d-flex justify-content-center align-items-center" style="height: 180px; color: white; font-size: 18px; background: #808080;">
                                        Loading thumbnail ...
                                </div>
                                <img v-else :src="video.thumb" style="width: 100%;" alt="">
                            </div>
